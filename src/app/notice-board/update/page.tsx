...
// Mock notice data - in real app, this would come from API
const mockNotices = [
  {
    id: "1",
      ...
      {!isMounted ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between border-b bg-white px-6 py-4">
            <div>
              <h1 className="text-xl font-semibold">Update Notice</h1>
              <p className="text-sm text-gray-500">Update existing notice</p>
            </div>
          ...
          <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
            <DialogContent className="max-w-lg p-8 text-center">
              <DialogHeader>
                <DialogTitle>Notice Updated Successfully</DialogTitle>
              </DialogHeader>
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-green-500 text-2xl text-white">
                ✓
              </div>
              <h2 className="text-xl font-semibold">Notice Updated Successfully</h2>
              <p className="text-muted-foreground mt-2 text-sm">
                Your notice <b>{formData.noticeTitle || "Untitled"}</b> has been updated.
              </p>
